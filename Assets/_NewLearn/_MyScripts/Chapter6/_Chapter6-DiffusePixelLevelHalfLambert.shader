...
Shader "Learn/Chapter6/_DiffusePixelLevelHalfLambert"
{
	Properties
	{
		...
		SubShader
		{
			Pass
			{
				...
				fixed4 frag(v2f i):SV_Target
				{
					...
					fixed3 diffuse = _LightColor0.rgb*_Diffuse.rgb*(0.5*dot(normalize(i.normal),normalize(worldLightDir))+0.5);//漫反射计算公式
