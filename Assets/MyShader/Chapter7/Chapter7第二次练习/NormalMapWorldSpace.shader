Shader "MyShader/Chapter7第二次练习/NormalMapWorldSpace" {
	Properties {
	...
	SubShader {
		Pass{
			...
			fixed4 frag(v2f i):SV_Target
			{
				...
				fixed3 tangentNormal;//这里指的是世界空间下的法线 我懒得换名字了
				...
				fixed3 diffuse = _LightColor0.rgb*albedo*saturate(dot(tangentNormal,worldViewDir));
